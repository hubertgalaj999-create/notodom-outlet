...
export const products: Product[] = [
  ...
  { id: 'tulipano-naroznik', name: 'Tulipano', fullName: 'Narożnik Tulipano', category: 'narozniki', categoryLabel: 'Narożniki', oldPrice: 22524, newPrice: 9500, images: ['/naroznik_tulipano.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Mega Okazja', badgeClass: 'badge-last', available: true },
  // SOFY
