...
export const products: Product[] = [
  ...
  { id: 'martinez-naroznik', name: 'Martinez 260-90-215', fullName: 'Narożnik Martinez 260-90-215', category: 'narozniki', categoryLabel: 'Narożniki', oldPrice: 3399, newPrice: 2900, images: ['/naroznik-martinez.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Wyprzedaż', badgeClass: 'badge-expo', dimensions: '260×90×215 cm', available: true },
  { id: 'polipol-naroznik', name: 'Polipol EM22001', fullName: 'Narożnik Polipol EM22001', category: 'narozniki', categoryLabel: 'Narożniki', oldPrice: 30207, newPrice: 12900, images: ['/naroznik-polipol-em22001.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Mega Okazja', badgeClass: 'badge-last', available: true },
  { id: 'tulipano-naroznik', name: 'Tulipano', fullName: 'Narożnik Tulipano', category: 'narozniki', categoryLabel: 'Narożniki', oldPrice: 22524, newPrice: 9500, images: ['/naroznik-tulipano.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Mega Okazja', badgeClass: 'badge-last', available: true },
  // SOFY
  ...
  { id: 'como-sofa', name: 'Como 2FBKA', fullName: 'Sofa Como 2FBKA', category: 'sofy', categoryLabel: 'Sofy', oldPrice: 1999, newPrice: 1599, images: ['/sofa-como.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Wyprzedaż', badgeClass: 'badge-expo', available: true },
  // WERSALKI
  ...
  // LEŻANKI
  { id: 'venice-lezanka', name: 'Venice', fullName: 'Leżanka Venice', category: 'lezanki', categoryLabel: 'Leżanki', oldPrice: 8266, newPrice: 2250, images: ['/lezanka-venice.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Mega Okazja', badgeClass: 'badge-last', available: true },
  // FOTELE
  ...
  { id: 'tve-uranos-fotel', name: 'TVE Uranos', fullName: 'Fotel TVE Uranos', category: 'fotele', categoryLabel: 'Fotele', oldPrice: 1329, newPrice: 999, images: ['/fotel-tve-uranos.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Wyprzedaż', badgeClass: 'badge-expo', available: true },
  { id: 'ultra-fotel', name: 'Ultra ES', fullName: 'Fotel Ultra ES', category: 'fotele', categoryLabel: 'Fotele', oldPrice: 1599, newPrice: 999, images: ['/fotel-ultra.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Wyprzedaż', badgeClass: 'badge-expo', available: true },
  ...
  { id: 'sensmore-fotel', name: 'Sensmore Relax', fullName: 'Fotel Relax Sensmore', category: 'fotele', categoryLabel: 'Fotele', oldPrice: 5029, newPrice: 3299, images: ['/fotel-sensmore.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Wyprzedaż', badgeClass: 'badge-expo', dimensions: '80×117×90 cm', available: true },
  { id: 'maks-fotel', name: 'Maks', fullName: 'Fotel Maks', category: 'fotele', categoryLabel: 'Fotele', oldPrice: 429, newPrice: 299, images: ['/fotel-maks.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Mega Okazja', badgeClass: 'badge-last', available: true },
  // KRZESŁA
  ...
  { id: 'lira-lozko', name: 'Lira 160', fullName: 'Łóżko Lira 160×200', category: 'lozka', categoryLabel: 'Łóżka', oldPrice: 2849, newPrice: 2499, images: ['/lozko-lira.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Wyprzedaż', badgeClass: 'badge-expo', dimensions: '160×200 cm', available: true },
  { id: 'theo-lozko', name: 'Theo', fullName: 'Łóżko Theo', category: 'lozka', categoryLabel: 'Łóżka', oldPrice: 4329, newPrice: 3199, images: ['/lozko-theo.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Wyprzedaż', badgeClass: 'badge-expo', available: true },
  // MATERACE
  ...
  { id: 'figaro-materac', name: 'Figaro Hilding', fullName: 'Materac Figaro Hilding', category: 'materace', categoryLabel: 'Materace', oldPrice: 8590, newPrice: 6590, images: ['/materac-figaro.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Wyprzedaż', badgeClass: 'badge-expo', available: true },
  { id: 'rumba-materac', name: 'Rumba 160/200', fullName: 'Materac Rumba 160/200', category: 'materace', categoryLabel: 'Materace', oldPrice: 4839, newPrice: 3800, images: ['/materac-rumba.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Mega Okazja', badgeClass: 'badge-last', dimensions: '160×200 cm', available: true },
  // ZESTAWY
  ...
  { id: 'forn-zestaw', name: 'Forn Stół + 4 Krzesła', fullName: 'Zestaw Forn – Stół + 4 Krzesła', category: 'zestawy', categoryLabel: 'Zestawy', oldPrice: 2415, newPrice: 1100, images: ['/zestaw-stol-forn-krzesla.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Mega Okazja', badgeClass: 'badge-last', available: true },
  // PUFY
  { id: 'livia-pufa', name: 'Livia', fullName: 'Pufa Livia', category: 'pufy', categoryLabel: 'Pufy', oldPrice: 670, newPrice: 359, images: ['/pufa-livia.jpg'], description: 'Opis produktu pojawi się wkrótce.', flaws: [], badge: 'Mega Okazja', badgeClass: 'badge-last', available: true },
  // AGD
